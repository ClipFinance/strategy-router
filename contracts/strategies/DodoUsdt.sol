...
contract DodoUsdt is DodoBase {
    constructor(
        ...
        DodoBase(
            _strategyRouter,
            IERC20Metadata(0x55d398326f99059fF775485246999027B3197955), // token - usdt mainnet on bsc
            IERC20Metadata(0x56ce908EeBafea026ab047CEe99a3afF039B4a33), // usdt lp token
